...
@ObjectModel: {
  sapObjectNodeType.name: 'ZRAP100_ATRAV904'
}
@AccessControl.authorizationCheck: #MANDATORY
define root view entity ZRAP100_C_TRAVELTP_904
  provider contract transactional_query
  as projection on ZRAP100_R_TRAVELTP_904
  association [1..1] to ZRAP100_R_TRAVELTP_904 as _BaseEntity on $projection.TravelID = _BaseEntity.TravelID
{
