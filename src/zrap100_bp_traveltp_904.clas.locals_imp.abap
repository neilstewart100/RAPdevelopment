CLASS lhc_zrap100_r_traveltp_904 DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
CONSTANTS:
...
CLASS lhc_zrap100_r_traveltp_904 IMPLEMENTATION.
  METHOD get_global_authorizations.
  ENDMETHOD.
  METHOD earlynumbering_create.
    DATA:
      entity           TYPE STRUCTURE FOR CREATE ZRAP100_R_TravelTP_904,
    ...
    ELSE.
      ...
      SELECT SINGLE FROM zrap100_atrav904 FIELDS MAX( travel_id ) AS travelID INTO @travel_id_max.
      "Get max travel ID from draft table
      SELECT SINGLE FROM zrap100_dtrav904 FIELDS MAX( travelid ) INTO @DATA(max_travelid_draft).
...
READ ENTITIES OF ZRAP100_R_TravelTP_904 IN LOCAL MODE
 ENTITY Travel
...
MODIFY ENTITIES OF ZRAP100_R_TravelTP_904 IN LOCAL MODE
  ENTITY Travel
    UPDATE SET FIELDS
...
METHOD deductDiscount.
  DATA travels_for_update TYPE TABLE FOR UPDATE ZRAP100_R_TravelTP_904.
...
METHOD copyTravel.
   DATA:
      travels       TYPE TABLE FOR CREATE zrap100_r_traveltp_904\\travel.
